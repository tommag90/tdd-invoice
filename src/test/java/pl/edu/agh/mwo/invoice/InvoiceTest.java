...
public class InvoiceTest {
	...
	public void testEmptyInvoiceHasEmptyTotal() {
		Assert.assertThat(BigDecimal.ZERO, Matchers.comparesEqualTo(invoice.getTotalGrossPrice()));
	}
	...
	public void testInvoiceHasTheSameSubtotalAndTotalIfTaxIsZero() {
		...
		Assert.assertThat(invoice.getTotalGrossPrice(), Matchers.comparesEqualTo(invoice.getTotalNetPrice()));
	}
	...
	public void testInvoiceHasProperTotalValueForManyProduct() {
		...
		Assert.assertThat(new BigDecimal("320.30"), Matchers.comparesEqualTo(invoice.getTotalGrossPrice()));
	}
	...
	public void testInvoiceHasPropoerTotalWithQuantityMoreThanOne() {
		...
		invoice.addProduct(new OtherProduct("Pinezka", new BigDecimal("0.01")), 1000);
		Assert.assertThat(new BigDecimal("54.70"), Matchers.comparesEqualTo(invoice.getTotalGrossPrice()));
	}
